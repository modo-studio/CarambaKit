...
public struct UrlRequestBuilder {
    ...
    public func build(parameterEncoding: UrlParameterEncoding = UrlParameterEncoding.URLEncodedInURL, bodyEncoding: UrlParameterEncoding = UrlParameterEncoding.JSON) -> NSURLRequest {
